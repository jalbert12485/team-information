...
const employeeQuestions=[new Question("input", "What is the employee's name?","name"),new Question("input", "What is the employee ID?", "id"),new Question("email", "What is the employee's email?", "email")];
